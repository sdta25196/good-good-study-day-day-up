...
- CTOBTOM 个性化。 搞个比赛，让用户上传服装印花，大家下单投票，赢的就直接进工厂开始做，做完发给用户。
- temu 一件定制，目前已经有团队在做。
...
围绕数据【数据闭环、壁垒、多样性、自然积累】、模型性能【垂类领域精准度、响应速度、多模态】、用户价值【智能客服、内容生成、个性化推荐】构建正向循环。

## 水果篮子

卖篮子的发现篮子不好卖了，降成本砍质量不是一条好路，他们发现把水果放到篮子里，可以变的好卖。

甚至水果篮子的价格 比 水果 + 篮子 要贵。

后来卖水果的知道了，他们自己买篮子加水果卖。

卖篮子的于是转行专门给买水果的供篮子。

> 如果我们现在创业做AI套皮的产品，是有机会再卖给大厂的。

### 产品落地

1. 要有好看的皮肤。
2. 快速开发MVP。至少效果要超过大厂的免费AI。
3. 去市场看反馈，有反馈就继续，没反馈就放弃。



# 产品 到 AI产品

产品升级 AI能力时：需要有一套完整流程逻辑，也有人称为的TPF的过程。 

全新的AI产品中，这套流程逻辑是和业务完全掺杂在一起的。更需要懂什么时候用什么能力。

目前来看，如果制作这套流程这件事，没有诞生全新的岗位的话，那么就是产品的工作。其实现在已经诞生了这个岗位了，AI产品。

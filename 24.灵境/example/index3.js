...
`
                ...
                fs.appendFileSync('./data/xwgData3.js', JSON.stringify(obj, null, 2) + ',\n')
                console.log('3-' + index + '完成')
                resolve()
            } catch (error) {
                // fs.appendFileSync('./data/xwgData3.js', JSON.stringify({ index: "3-" + index }, null, 2) + ',\n')
                console.log('3-' + index + '出错并完成')
                resolve()
            }
        });
    })

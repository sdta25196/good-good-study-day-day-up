...
`
                ...
                fs.appendFileSync('./data/xwgData2.js', JSON.stringify(obj, null, 2) + ',\n')
                console.log('2-' + index + '完成')
                resolve()
            } catch (error) {
                // fs.appendFileSync('./data/xwgData2.js', JSON.stringify({ index: "2-" + index }, null, 2) + ',\n')
                console.log('2-' + index + '出错并完成')
                resolve()
            }
        });
    })

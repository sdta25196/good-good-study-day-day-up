...
3. 提示词怎么修改成自己的，调试信息里有一堆不是我写的东西。而且我自制的prompt模版在导入界面搜索不到  **使用bug**
4. 知识库答案中是否可以包含 markdown 或者 富文本 **测试一下**
5. 知识库回答速度较慢。是否有办法提升？ **目前没有，算力有限**
6. 我是否可以提供一些简单的问题来覆盖大模型的回答。例如：你是谁？ 回答我是掌上高考智能客服 **测试一下**
7. 根据教程中的案例，实际测试 提示词和其他插件都不生效 **使用bug**
